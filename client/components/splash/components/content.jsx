        ...
        <div>
            <div className="grid-3Ykf_K">
                <div className="row-3wW-Fx container-3iEQmT imageLeft-1VXvAQ visible-hh3e_5">
                    ...
                    <div className="description-1K7RzO">
                        <h2 className="h2-25VyWe">Join a public or invite-only hive where hanging out is easy</h2>
                        <div className="text-3U-SDd textMedium-1DcD2z subtitle-1ZS-lq">Through endless conversation and authentic human connections, buzzhive provides access to the right people, information, and tools for every activity from discussing interests to achieving ambitions.</div>
                    </div>
                </div>
            </div>
            ...
            <div className="grid-3Ykf_K greyBackground-2ATEHg">
                <div className="row-3wW-Fx container-3iEQmT imageRight-2P6qcK visible-hh3e_5">
                    ...
                    <div className="description-1K7RzO">
                        <h2 className="h2-25VyWe">There's a hive for every project</h2>
                        <div className="text-3U-SDd textMedium-1DcD2z subtitle-1ZS-lq"><b>Hives</b> keep work organized. You don’t have to think twice about where to go to ask a question or make a decision.</div>
                    </div>
                </div>
            </div>
